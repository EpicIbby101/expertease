...
import { motion, useMotionValue, useTransform, animate, Variants, Transition } from "framer-motion";
...
function HeroGeometric({
  ...
  title1 = "Empower Your Workforce with Expert Training",
}: {
  badge?: string;
  title1?: string;
  title2?: string;
      ...
      <div className="relative z-10 w-full mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="px-2"
          >
            <h1 className="text-4xl sm:text-6xl md:text-6xl font-bold mb-3 md:mb-8 tracking-tight">
          ...
          >
            <p className="text-sm sm:text-base md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-2">
              At Expert Ease Training, we specialize in transforming workers
              into industry leaders through focused training. Partner with us to
              ensure your team excels in today's demanding environment.
            </p>
          </motion.div>

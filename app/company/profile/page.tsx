      ...
      <div className="mx-auto max-w-3xl space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Information on file for your administrator account. This page is read-only.
          </p>
        </div>
        ...
        <Alert>
          ...
          <AlertDescription className="mt-1 text-gray-700">
            Employment and profile fields are usually maintained when your account was provisioned. Contact
            Expert Ease support or your site administrator if anything needs correcting.
          </AlertDescription>
        </Alert>
        ...
        {error ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Synced from your organization&apos;s records</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              {user.created_at ? (
                <p className="text-xs text-gray-400">
                  Member since {format(new Date(user.created_at as string), 'MMMM d, yyyy')}
                </p>
              ) : null}
            </CardContent>
          </Card>

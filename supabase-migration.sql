-- Expert Ease Database Migration
-- Run this SQL in your Supabase SQL Editor

-- =============================================
-- 1. USERS SOFT DELETE MIGRATION
-- =============================================

-- Add soft delete columns to users table
ALTER TABLE users ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS deleted_by TEXT REFERENCES users(id) ON DELETE SET NULL;
...
-- =============================================
-- 4. INSERT DEFAULT SYSTEM CONFIGURATION
-- =============================================
